$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', ctx + '/resources/ui/charisma/' + 'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', ctx + '/resources/ui/charisma/' + 'css/' + themeName + '/bootstrap.min.css');
        }
