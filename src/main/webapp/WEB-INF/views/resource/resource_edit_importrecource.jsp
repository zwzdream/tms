                ...
                <form role="form" id="editResource">
                 <input type="hidden"  id="id" name="id" value="${bean.id}">
                    ...
                    <div class="form-inline">
                        ...
                        <label id="existFile">You have upLoaded the following file:<span style="color:GREEN">${bean.filePath }</span></label>
                        <p class="help-block">Please upload your resume.</p>
                    </div>
                    <button type="button" class="btn btn-default" onclick="updateResource('content','editResource')">Submit</button>
                </form>
