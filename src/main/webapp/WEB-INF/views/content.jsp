...
<div class="sortable row-fluid">
 	<div class="col-md-6 col-sm-6 col-xs-6">
        <a data-toggle="tooltip" title=" ${curJDCount } more JDs." class="well top-block" href="javascript:ajaxGet('/Index/home/JD');">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        <a data-toggle="tooltip" title=" ${curResourceCount } more Resources." class="well top-block" href="javascript:ajaxGet('/Index/home/resource');">
